...
export default function Edit({ product, categories, groups , statuses }: { product: Product, categories: Option[]; groups: Option[]; statuses: Option[] }) {
    return (
                        ...
                        {({ processing, errors }) => (
                            ...
                            <> {Object.values(errors).length > 0 && (
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Input id="position" type="number" name="position" placeholder="1" defaultValue={product.position} />
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Select name="product_category_id" defaultValue={product.product_category_id ?? undefined}>
                                        <SelectTrigger>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <Select name="product_group_id" defaultValue={product.product_group_id ?? undefined}>
                                        <SelectTrigger>
